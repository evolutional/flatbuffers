...
public struct Monster : Accessor
{
  private Table __p;
  ...
  public TTable? Test<TTable>() where TTable : struct, Accessor { int o = __p.__offset(20); return o != 0 ? (TTable?)__p.__union<TTable>(o) : null; }
